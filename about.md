...
안녕하세요! 4년 차, 프론트엔드 개발자 김현서입니다. 사용자가 직접 이용하게 될 화면을 개발하는 것에 매력을 느껴 프론트엔드 개발을 시작하게 되었습니다. 
...
개발한 솔루션은 프로세스 마이닝을 위한 대용량 데이터 기반 데이터 시각화 프로그램입니다.
...
사이드 프로젝트로 TypeScript, React를 활용해 오늘의날씨를 그래프로 시각화해서 편하게 볼 수있는 프로그램을 개발했습니다.
프로젝트를 진행하면서 Container/Presentational 패턴을 사용했고 Redux-toolkit을 활용한 상태 관리와 styled-component를 이용한 동적 스타일링을 능숙하게 다룰 수 있게 되었습니다.
